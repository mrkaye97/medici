...
declare module '$env/static/private' {
	...
	export const DOTENVENC_PASS: string;
	...
	export const HATCHET_COMPUTE_EXAMPLE__HATCHET_CLIENT_TOKEN: string;
	...
	export const RENTCAST_API_KEY: string;
	...
	export const HATCHET_COMPUTE_EXAMPLE__OPENAI_API_KEY: string;
	export const HATCHET_COMPUTE_EXAMPLE__OPENAI_ORGANIZATION: string;
	...
	export const HATCHET_COMPUTE_EXAMPLE__DATABASE_URL: string;
	...
	export const HATCHET_COMPUTE_EXAMPLE__API_KEY: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		NVM_CD_FLAGS: string;
		HATCHET_COMPUTE_EXAMPLE__HATCHET_CLIENT_TOKEN: string;
		...
		HATCHET_COMPUTE_EXAMPLE__OPENAI_API_KEY: string;
		HATCHET_COMPUTE_EXAMPLE__OPENAI_ORGANIZATION: string;
		...
		HATCHET_COMPUTE_EXAMPLE__DATABASE_URL: string;
		LOGNAME: string;
		...
		HATCHET_COMPUTE_EXAMPLE__API_KEY: string;
