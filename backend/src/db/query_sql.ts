...
export async function listFriendPoolMembershipStatus(
  client: Client,
  args: ListFriendPoolMembershipStatusArgs,
): Promise<ListFriendPoolMembershipStatusRow[]> {
  const result = await client.query({
...
export async function addFriendToPool(
  client: Client,
  args: AddFriendToPoolArgs,
): Promise<AddFriendToPoolRow | null> {
  const result = await client.query({
...
export async function removeFriendFromPool(
  client: Client,
  args: RemoveFriendFromPoolArgs,
): Promise<void> {
  await client.query({
...
export async function createPoolMembership(
  client: Client,
  args: CreatePoolMembershipArgs,
): Promise<CreatePoolMembershipRow | null> {
  const result = await client.query({
...
export async function listFriends(
  client: Client,
  args: ListFriendsArgs,
): Promise<ListFriendsRow[]> {
  const result = await client.query({
...
export async function listInboundFriendRequests(
  client: Client,
  args: ListInboundFriendRequestsArgs,
): Promise<ListInboundFriendRequestsRow[]> {
  const result = await client.query({
